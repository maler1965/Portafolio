  ...
  return (
    <div>
      <section>
        ...
        <section
          className={`  ${
            darkValue ? "text-black" : " text-white"
          } transition-opacity`}
        >
          <div className="flex flex-col md:flex-row">
            <article className="flex flex-col justify-center text-center w-full md:w-1/2 order-2 md:order-1">
              ...
              <p className=" p-2 text-2xl font-bold">
                Soy un programador
                <span className="text-[#495def] mx-2">full-stack</span> usando
                la tecnologia <span className="text-[#495def] mx-2">React</span>{" "}
              </p>
              <p className=" p-2 text-2xl font-bold">
                Con habilidades en el uso de:{" "}
                <span className="text-[#495def] mx-2">
                  Redux, React-Router,
                </span>
              </p>
              <p className=" p-2 text-2xl font-bold">
                <span className="text-[#495def] mx-2">
                  Axios, React-Hook-Form, TailwindCSS
                </span>{" "}
                y otros.
              </p>
              <a
                href="https://verified.sertifier.com/en/verify/45534293898143/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#495def] mx-4"
              >
                Ver Certificado de React
              </a>

              <p className=" p-2 text-2xl font-bold">
                Ademas utilizo
                <span className="text-[#495def] mx-2">NODEJS</span> usando
                tecnologias como{" "}
                <span className="text-[#495def] mx-2">Express</span>{" "}
              </p>
              <p className=" p-2 text-2xl font-bold">
                Con habilidades en el uso de:{" "}
                <span className="text-[#495def] mx-2">
                  Routers, Base de Datos PostgreSQL, con Sequelize.
                </span>
              </p>
              <a
                href="https://verified.sertifier.com/en/verify/45534293898143/"
              ...
              <div>
                <div className="bg-stone-700 bg-opacity-30 p-4 m-8 rounded-xl overflow-x-hidden">
                  <h2 className="p-2">
                    Soy <span className="font-bold">PEDRO CEVALLOS </span>{" "}
                  </h2>
                  <a
                    href="/CV_Pedro_Cevallos.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    ...
                    <div className="flex justify-center">
                      <div className="bg-white rounded-xl px-4">
                        <p className="text-[#495def] font-bold text-center">
                          Mira mi CV
                        </p>
                      </div>
                    </div>
                  ...
                  <p id="home" className="p-2">
                    Con dedicación y entrega en el trabajo, es posible alcanzar
                    grandes logros,
                  </p>
                  ...
                  <h2 className="p-2">
                    {" "}
                    Si deseas conocer mas detalles de mi,{" "}
                  </h2>
                  <div className="flex justify-center">
                    <button className="flex justify-center p-4">
                      ...
                      <a
                        href="#about"
                        className=" border border-white text-[#495def] rounded-md p-2"
                      >
                        clic aquí
                      </a>{" "}
                    </button>
          ...
          <div className="flex justify-center">
            <h1 className="text-[#495def] mx-2 p-2 text-center text-2xl font-bold">
              MIRA MIS PROYECTOS
            </h1>
          </div>

          <div className="flex justify-center">
            <h2 className="text-[#495def] mx-2 p-2 text-center text-2xl font-bold">
              UTILIZANDO LAS TECNOLOGIAS ANTES MENCIONADAS
            </h2>
          </div>
          ...
          <div className="p-2 m-2 flex flex-col md:flex-row justify-center ">
            <div
              id="projects"
              className="p-2 m-2 flex items-center max-w-[350px] md:w-1/2 order-1 md:order-2"
            >
              <p className="p-4">
                Conozca el{" "}
                <span className="text-[#495def]">
                  {" "}
                  loco univerzo de “Rick and Morty”
                </span>
                . Un sitio donde el usuario puede ver información sobre los
                universos de la serie de caricatura de "Rick and Morty" y
                aprender sobre los distintos personajes de la serie..
              </p>
            </div>
            ...
            <div className="relative  md:w-1/2 order-2 md:order-1">
              <a
                href="https://rainbow-gecko-d06cfb.netlify.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          <div className="p-2 m-2 flex flex-col md:flex-row justify-center ">
            <div
              id="projects"
              className="p-2 m-2 flex items-center max-w-[350px] "
            >
              <p className="p-4">
                Vea los{" "}
                <span className="text-[#495def]">
                  pokemons traidos de la base de datos de pokeapi
                </span>
                . Cada tarjeta tiene información de cada pokemon, puedes buscar
                información usando el id del pokemon o usando su nombre
              </p>
            </div>

            <div className="relative">
              <a
                href="https://rococo-crepe-45147b.netlify.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="p-2  relative flex flex-col justify-end ">
