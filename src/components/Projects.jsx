                ...
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4 p-4">
                    ...
                    <div className='bg-stone-900 bg-opacity-50 rounded-xl shadow-md gap-4 flex flex-col justify-between w-[202px] h-[200px] m-2 p-2'>
                        <a href="https://carrito-fundamentos-pedro.netlify.app/" target="_blank" rel="noopener noreferrer" >
                            ...
                            <p className='px-4 flex justify-center bg-white rounded-xl text-[#495def] font-bold text-center'> CARRITO DE COMPRAS</p>
                            <p className='px-4 flex justify-center text-center'> Proyecto con productos expuestos al usuario y su carrito para compras</p>
                        </a>
                    </div>
                    ...
                    <div className='bg-stone-900 bg-opacity-50 rounded-xl shadow-md gap-4 flex flex-col justify-between w-[202px] h-[200px] m-2 p-2'>
                        <a href="https://reliable-sfogliatella-535f2d.netlify.app/" target="_blank" rel="noopener noreferrer" >
                            ...
                            <p className='px-4 flex justify-center bg-white rounded-xl text-[#495def] font-bold text-center'> MANEJANDO UNA API</p>
                            <p className='px-4 flex justify-center text-center'> Administrando usuarios a través de un CRUD usando una API</p>
                        </a>
                    </div>
                    ...
                    <div className='bg-stone-900 bg-opacity-50 rounded-xl shadow-md gap-4 flex flex-col justify-between w-[202px] h-[200px] m-2 p-2'>
                        <a href="https://transcendent-melba-a49caf.netlify.app/" target="_blank" rel="noopener noreferrer" >
                            ...
                            <p className='px-4 bg-white rounded-xl flex justify-center text-[#495def] font-bold text-center'> FRASES ALEATORIAS</p>
                            <p className='px-4 flex justify-center text-center'> Mostrar aleatoriamente una frase y un fondo al hacer clic</p>
                        </a>
                    </div>
